...
class SideBarTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if cell == nil {
            ...
            let selectdView: UIView = UIView(frame: CGRect(x: 0, y: 0, width: cell!.frame.size.width, height: cell!.frame.size.height))
            selectdView.backgroundColor = UIColor.blackColor().colorWithAlphaComponent(0.3)
